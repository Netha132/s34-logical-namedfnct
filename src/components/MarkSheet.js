...
function MarkSheet() {
    ...
    let calculateMarks=()=>{
        let firstName=firstNameInputRef.current.value;
            ...
            // alert(`${firstName} ${lastName} got total Marks of ${totalMarks} percentage of ${totalPerc}`)

            resultSpan.current.innerHTML=`${firstName} ${lastName} got total Marks of ${totalMarks} percentage of ${totalPerc.toFixed(2)}`; 
    }
